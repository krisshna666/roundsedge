...
const routes: Routes = [
  ...
  {path:'mainadmin',component:MainadminComponent,canActivate:[TestCanActivate],canDeactivate:[TestCanDeactivate],children:[{path:'list',component:UserlistComponent},  {path:'mainusers',component:MainusersComponent},{path:'administrator',component:AdminComponent},{path:'chat',component:ChatComponent}]},
